 ...
 */
do_action( 'make_section_phila_gov_before_columns_select', $ttfmake_section_data );
 ...
 * @param array    $ttfmake_section_data    The data for the section.
 */
do_action( 'make_section_phila_gov_after_columns_select', $ttfmake_section_data );
 ...
 * @param array    $ttfmake_section_data    The data for the section.
 */
do_action( 'make_section_phila_gov_after_title', $ttfmake_section_data ); ?>

<div class="ttfmake-phila_gov-columns-stage ttfmake-phila_gov-columns-<?php echo $columns_class; ?>">
	...
	<?php
		...
		$column_buttons = array(
			...
			200 => array(
				'label'              => __( 'Edit phila_gov column', 'make' ),
				'href'               => '#',
				'class'              => 'edit-content-link edit-phila_gov-column-link' . $item_has_content,
		 ...
		 */
		$column_classes = apply_filters( 'ttfmake-phila_gov-column-classes', 'ttfmake-phila_gov-column ttfmake-phila_gov-column-position-' . $j, $i, $ttfmake_section_data );
	?>
	<div class="<?php echo esc_attr( $column_classes ); ?>" data-id="<?php echo $i; ?>">
		 ...
		 * @param array    $ttfmake_section_data    The data for the section.
		 */
		do_action( 'make_section_phila_gov_before_column', $ttfmake_section_data, $i );
		?>
		 ...
		 * @param array    $ttfmake_section_data    The data for the section.
		 */
		do_action( 'make_section_phila_gov_after_column', $ttfmake_section_data, $i );
		?>
 ...
 * @param array    $ttfmake_section_data    The data for the section.
 */
do_action( 'make_section_phila_gov_after_columns', $ttfmake_section_data );
?>

<div class="clear"></div>

<input type="hidden" value="<?php echo esc_attr( implode( ',', $section_order ) ); ?>" name="<?php echo $section_name; ?>[columns-order]" class="ttfmake-phila_gov-columns-order" />
